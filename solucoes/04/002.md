...
namespace EjerciciosResolucion
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            sub.Unsubscribe(obfile);
            //Limpa a lista de ovservadores.
            sub.EndTransmission();            
        }
    }
}
...
namespace PatternObserver
{
    public class Subject : IObservable<ConsoleKeyInfo>
    {
        ...
        public void Unsubscribe(IObserver<ConsoleKeyInfo> ob)
        {
            // Recolher o subscriptor
            IDisposable endSub = Subscribe(ob);
            // Mensagem para saber que termina o intercambio
            Console.WriteLine("End of data transmision " + ob);
            // Apagar subscripçao do observador
            endSub.Dispose();
        }
        public void EndTransmission()
        {
            foreach (ICollection<IObserver<ConsoleKeyInfo>> ob in observer)
            {
                // Limpa o Hasset de observadores.
                observer.Clear();
            }
        }
    }
