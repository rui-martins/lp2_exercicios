...
namespace LP2_Exercicios
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            /* KeyReader subscribes both KeyPrinter and KeySaver observers */
...
namespace LP2_Exercicios
{
    public class KeySaver : IObserver<ConsoleKeyInfo>
    {
        ...
        private string path = Path.Combine(
            Environment.GetFolderPath(Environment.SpecialFolder.Desktop), "file.txt");
...
namespace LP2_Exercicios
{
    class Unsubscriber : IDisposable
    {
        ...
        public Unsubscriber(List<IObserver<ConsoleKeyInfo>> observers, IObserver<ConsoleKeyInfo> observer)
        {
