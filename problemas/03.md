...
12 - Um dos possíveis usos para os dicionários é como
[_cache_](https://en.wikipedia.org/wiki/Cache_%28computing%29). Escreve um
programa que leia a lista de jogos disponível
[aqui](https://pastebin.com/dl/EuxZMbWT) para um _array_ de _strings_, e que
solicite ao utilizador (em ciclo infinito) que faça uma procura. Para existir
um _match_ basta que a _string_ que representa o jogo
[contenha](https://docs.microsoft.com/dotnet/api/system.string.contains) a
frase escrita pelo utilizador. A procura deve ser independente de maiúsculas e
...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            // String a procurar
            string searchString;
            // Resultados da procura, têm que ser enumeráveis e contáveis
