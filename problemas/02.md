...
apropriada contendo o valor convertido. Caso contrário, mostra uma mensagem
com indicação de insucesso. O programa termina quando o utilizador insere
uma *string* vazia (isto é, simplesmente pressiona ENTER sem escrever nada).
