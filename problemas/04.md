...
<!-- Considera um jogo _tile-based_, em que cada _tile_ tem as seguintes
propriedades:
...
Inicialmente existem os seguintes tipo de _tile_ com as características
indicadas:

*   _Grassland_: DEF = 0, ESS = 3, LUX = 0
*   _Desert_: DEF = -1, ESS = 0, LUX = 1
*   Selva (DEF = 1, ESS = 1, LUX = 1)
*   Montanha (DEF = 3, ESS = 1, LUX = 1)

Além disso, cada tipo de _tile_ pode ainda ter características
