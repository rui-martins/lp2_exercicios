...
apropriados ao problema, devendo ainda verificar, usando excepções, possíveis
...
para conversão explícita de instâncias da mesma em _string_, tal que a _string_
gerada represente os conteúdos do _array_ `secretPassphrase`. Por exemplo, se
os conteúdos deste _array_ forem
